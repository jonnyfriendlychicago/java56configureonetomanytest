...
<body>
	...
	<div id=main class="container-fluid">
		<div id=form class="container-fluid">
			...
			<%-- <form:form action='/store/category/new' method='post' modelAttribute='category'> --%>
			<form:form action='/category/new' method='post' modelAttribute='category'>
				...
				<div class="form-group">
					<form:label path="categoryName" for="categoryName">categoryName</form:label>
					<form:input type="text" class="form-control" path="categoryName"/>
					<p class="errorText"><form:errors path="categoryName" />
					</p>
				</div>
<%-- 
				<div class="form-group">
